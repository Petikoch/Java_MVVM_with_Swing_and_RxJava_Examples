...
class Example_3_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_3_Model model = new Example_3_Model();
        Example_3_ViewModel viewModel = new Example_3_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_3_View view = new Example_3_View();
            view.bind(viewModel);
