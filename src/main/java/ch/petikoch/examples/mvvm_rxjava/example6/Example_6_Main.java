...
class Example_6_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_6_Model model = new Example_6_Model();
        Example_6_ViewModel viewModel = new Example_6_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_6_View view = new Example_6_View();
            view.bind(viewModel);
