...
class Example_9_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_9_Model model = new Example_9_Model();
        Example_9_ViewModel viewModel = new Example_9_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_9_View view = new Example_9_View();
            view.bind(viewModel);
