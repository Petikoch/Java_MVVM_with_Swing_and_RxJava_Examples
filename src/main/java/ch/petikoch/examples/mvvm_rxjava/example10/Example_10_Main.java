...
class Example_10_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_10_Model model = new Example_10_Model();
        Example_10_ViewModel viewModel = new Example_10_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_10_View view = new Example_10_View();
            view.bind(viewModel);
