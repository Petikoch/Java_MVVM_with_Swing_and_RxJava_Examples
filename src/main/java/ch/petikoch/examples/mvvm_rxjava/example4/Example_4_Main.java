...
class Example_4_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_4_Model model = new Example_4_Model();
        Example_4_ViewModel viewModel = new Example_4_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_4_View view = new Example_4_View();
            view.bind(viewModel);
