...
class Example_4_View extends StrictThreadingJFrame implements IView<Example_4_ViewModel> {
    ...
    public void bind(final Example_4_ViewModel viewModel) {
