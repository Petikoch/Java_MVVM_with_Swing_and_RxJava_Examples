...
class Example_5a_View extends StrictThreadingJFrame implements IView<Example_5a_ViewModel> {
    ...
    @Override
    public void bind(final Example_5a_ViewModel viewModel) {
