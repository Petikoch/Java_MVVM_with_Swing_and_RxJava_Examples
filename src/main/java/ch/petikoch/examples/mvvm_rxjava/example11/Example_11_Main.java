...
class Example_11_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_11_Model model = new Example_11_Model();
        Example_11_ViewModel viewModel = new Example_11_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_11_View view = new Example_11_View();
            view.bind(viewModel);
