...
class Example_5_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_5_Model model = new Example_5_Model();
        Example_5_ViewModel viewModel = new Example_5_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());

            Example_5_View view = new Example_5_View();
            view.bind(viewModel);
