...
class Example_7_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_7_Model model = new Example_7_Model();
        Example_7_ViewModel viewModel = new Example_7_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
            Example_7_View view = new Example_7_View();
            view.bind(viewModel);
