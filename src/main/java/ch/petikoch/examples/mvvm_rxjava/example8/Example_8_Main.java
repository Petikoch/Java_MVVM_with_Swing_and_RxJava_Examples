...
class Example_8_Main {
    ...
    public static void main(String[] args) {
        ...
        Example_8_Model model = new Example_8_Model();
        Example_8_ViewModel viewModel = new Example_8_ViewModel();
        viewModel.connectTo(model);

        SwingUtilities2.invokeLater(() -> {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
            Example_8_View view = new Example_8_View();
            view.bind(viewModel);
